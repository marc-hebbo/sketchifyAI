...
import { PenLine, Wand2, Palette, Zap, ArrowRight } from "lucide-react";
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
              ...
              <a
                href="#features"
                className="px-6 py-2.5 rounded-lg border border-muted-foreground/30 text-muted-foreground hover:text-foreground hover:border-muted-foreground/60 transition-colors font-medium"
              >
                Learn More
              </a>
            </div>
